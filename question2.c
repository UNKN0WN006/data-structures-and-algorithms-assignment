...
int main() {
    ...
    strcpy(students[count].address, "123 Street");
    students[count].marks[0] = 90; // Math
    students[count].marks[1] = 85; // Physics
    students[count].marks[2] = 70;
    students[count].marks[3] = 75;
    students[count].marks[4] = 80;
    count++;
